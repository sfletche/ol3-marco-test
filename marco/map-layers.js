...
getMapLayers = function() {
    ...
    var getFeatureOverlay = function(map) {
        if (app && app.featureOverlay) {
    ...
    return {
        getCanyonLayer: getCanyonLayer,
        getCoralLayer: getCoralLayer, 
        getSeabedLayer: getSeabedLayer,
